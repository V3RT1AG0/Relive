...
const updateUploadRealm = (AlbumId, Image) => {
    console.log(AlbumId, Image, "triggeredUpdateUPloadrealm")
    // here Image is a realm object so it can be modified directly
    UploadRealm.write(() => {
        try {
            Image.uploaded = true
        }
                ...
                Upload.startUpload(options)
                    .then(uploadId => {
                        ...
                        Upload.addListener("completed", uploadId, data => {
                            ...
                            updateUploadRealm(AlbumId, image);
