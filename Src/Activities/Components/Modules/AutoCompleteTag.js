    ...
    renderTags = () => {
        ...
        return (
            <View style={this.props.tagStyles || styles.tags}>
                {/*My code*/}
                {this.props.tagsSelected.length!==0?<Text style={{fontSize: 15,marginStart:15,color:"#90A4AE",paddingTop:10}}>with</Text>:undefined}
                            ...
                            {this.props.renderSuggestion ? (
                                ...
                                <View style={styles.suggestionListItems}>
                                    <Image
                                        ...
                                        source={{uri: 'https://sharekoube.files.wordpress.com/2012/03/berserker.jpg'}}
                                    />
                                    <Text style={{fontSize:15,paddingStart:10}}>{suggestion.name}</Text>
