...
import {
    View,
    Text,
    Animated, Easing, TextInput, TouchableHighlight
} from "react-native";
...
export default class VideoScreen extends React.Component {
    ...
    state = {
        examples: ["Birthday..", "Farewell..", "Nightout..",
            "Trekking.."],
        index: 0
        //text:""
    };
    ...
    startFadeAnimation = () => {
        ...
        Animated.timing(this.animatableValue, {
            ...
            this.setState({index: this.state.index < this.state.examples.length - 1 ? this.state.index + 1 : 0})
            animation.finished ? this.startFadeAnimation() : this.animatableValue.setValue(0.5)
